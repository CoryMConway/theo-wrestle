    ...
    return (
      <>
        ...
        <div
          ...
          data-mobile="true"
          className={cn(
            "bg-sidebar text-sidebar-foreground fixed inset-y-0 z-50 flex h-svh flex-col transition-transform duration-200 ease-in-out",
            side === "left"
              ? "left-0 border-r"
              : "right-0 border-l",
...
function SidebarMenuSkeleton({
  ...
  return (
    ...
    >
      {showIcon && (
        <div className="bg-sidebar-accent-foreground/10 flex size-4 items-center justify-center rounded-md">
